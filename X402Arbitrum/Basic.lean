-- x402-Arbitrum Basic | Author: Richard Patterson (@De-ASI-INTERFACE)
...
theorem arbitrum_replay_prevented (a : PaymentAuth) (s : FacilitatorState) (h : verify a s)
    : a.nonce ∉ s.used_nonces := h.1

theorem arbitrum_not_expired (a : PaymentAuth) (s : FacilitatorState) (h : verify a s)
